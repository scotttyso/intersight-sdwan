...
def config_credentials(description=None):
    ...
    Parser.add_argument('-l', '--api-key-legacy', action='store_true',
    ...
    Parser.add_argument(
        ...
        '--devices',
        required=True,
        help='JSON file with device access information (device hostname, username, password, and proxy settings if required)'
    )
    ...
    return api_client,devices_list
